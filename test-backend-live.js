...
const BackendService_1 = require("./src/lib/backend/BackendService");
const ALObjectType_1 = require("./src/lib/types/ALObjectType");
const Logger_1 = require("./src/lib/utils/Logger");
...
function testLiveBackend() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                const result = yield backendService.checkApp(testAppId);
            ...
            try {
                ...
                const result = yield backendService.authorizeApp(request);
            ...
            if (authKey) {
                ...
                try {
                    const request = {
                        appId: testAppId,
                        type: ALObjectType_1.ALObjectType.Table,
                        ranges: [{ from: 50000, to: 50099 }],
                        authKey,
                        perRange: false
                    };
                    const result = yield backendService.getNext(request);
                ...
                try {
                    const request = {
                        ...
                        authKey,
                        ids: {
                            [ALObjectType_1.ALObjectType.Table]: [50000, 50001, 50002],
                            [ALObjectType_1.ALObjectType.Page]: [50100, 50101],
                            [ALObjectType_1.ALObjectType.Codeunit]: [50200]
                        }
                    };
                    const result = yield backendService.syncIds(request);
                    if (result) {
                ...
                try {
                    // Create pool
                    const createResult = yield backendService.createPool(testAppId, authKey);
                    if (createResult && createResult.poolId) {
                        ...
                        // Leave pool
                        const leaveResult = yield backendService.leavePool(testAppId, authKey);
                        if (leaveResult) {
...
//# sourceMappingURL=test-backend-live.js.map